      ...
      leng=1;
        ...
        while(~feof(gtfile)); % go into the detections 
            ...
            if ( ~isempty(InputText{1,1}))
              ...
              d = b{1,1};
             frames(1,feames_index)=(str2num(d{1,1}));
             ...
             if (~strcmp(d{2, 1},'NaN'))   
               ...
               % euclidean distance between trhe previous post and theactual point
                ...
                cont = (str2num(d{7,1}))+1; % I need to add 1 
                     ...
                     if (~isequal (lastcontext , cont))
                      ...
                      % and the new chunk should be sticked to the previous
                      % one.
                              if (prevlen >3 &&  D <15 ) 
                                ...
                                % contextual(lastcontext + prevcontext,1) =  leng;
                                contextual(prevcontext+contextnumber,1) =  leng-1;
